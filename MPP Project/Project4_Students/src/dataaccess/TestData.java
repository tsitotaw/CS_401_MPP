...
public class TestData {
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			add(new Book("11-111", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1))));
	...
	List<CheckOutRecord> allCheckOutRecords = new ArrayList<CheckOutRecord>() {
		{			
			add(new CheckOutRecord(new LibraryMember("1001", "Andy", "Rogers", "641-223-2211", addresses.get(4)),	allBooks.get(0),LocalDate.now(),LocalDate.now().plus(7,ChronoUnit.DAYS)));
			add(new CheckOutRecord(new LibraryMember("1002", "Drew", "Stevens", "702-998-2414", addresses.get(5)),	allBooks.get(1),LocalDate.now(),LocalDate.now().plus(21,ChronoUnit.DAYS)));
