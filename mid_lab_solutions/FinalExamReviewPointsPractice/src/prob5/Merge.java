...
public class Merge {
	...
	public static void main(String[] args) {
		...
		System.out.println(merge(list5, list6, (a, b) -> a.doubleValue() > b.doubleValue() ? 1 : a == b ? 0 : -1));

		System.out.println(merge(list7, list1, (a, b) -> {
			int aValue = a.getClass().equals(String.class) ? a.toString().length() : Integer.parseInt(a.toString());
			int bValue = b.getClass().equals(String.class) ? b.toString().length() : Integer.parseInt(b.toString());
	...
	//public static <T extends Serializable> List<T> merge(List<? extends T> list1, List<? extends T> list2,
