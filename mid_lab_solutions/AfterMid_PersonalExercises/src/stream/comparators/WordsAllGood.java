...
public class WordsAllGood {
	public static void main(String[] args) {
		goodSort1(Comparator.comparing(String::length, Comparator.reverseOrder()));
		goodSort2();
	}
	
	public static <T> void goodSort1(Comparator<? super String> comp) {
		List<String> words = Arrays.asList("Tom", "Joseph", "Richard");
		Stream<String> longestFirst  
		//    = words.stream().sorted(Comparator.comparing(String::length).reversed());
		= words.stream().sorted(comp);
